    ...
    def test_pull_request_from_main_repo(self, tmp_path):
        ...
        event_data = {
            "pull_request": {
                "head": {
                    "ref": "fix-something",
                    "repo": {"full_name": "mill1000/esphome-ratgdo"},
                }
            }
        }
        event_file.write_text(json.dumps(event_data))
        ...
        with mock.patch.dict(
            ...
            assert fork_repo == "mill1000/esphome-ratgdo"
...
external_components:
  - source:
      type: git
      url: https://github.com/mill1000/esphome-ratgdo
      ref: main
    refresh: 1s
"""
...
"""
        ...
        assert "url: https://github.com/mill1000/esphome-ratgdo" not in updated_content
...
"""
    ...
    def test_remove_dashboard_import_package_url(self, tmp_path):
        ...
        yaml_content = """
dashboard_import:
  package_import_url: github://mill1000/esphome-ratgdo/v2board.yaml@main
"""
        yaml_file = tmp_path / "test.yaml"
        yaml_file.write_text(yaml_content)
...
dashboard_import:
  package_import_url: github://mill1000/esphome-ratgdo/v25board.yaml@main
...
"""
        ...
        assert updated_content.count("github.com/mill1000/esphome-ratgdo") == 0
